...
// For desktop view, renders all desktop steps in a single row and adds connecting line segments.
// After the first step's text animation, an arrow is animated along the first connecting line.
//
// DesktopTimeline Component:
// For desktop view, renders all desktop steps in a single row and adds connecting line segments.
// The arrow animation on the first connecting line has been removed.
